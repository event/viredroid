...
public class ViredroidExceptionHandler implements UncaughtExceptionHandler {


    private Context context;
    private static Context context1;

    public ViredroidExceptionHandler(Context ctx) {
        context = ctx;
        context1 = ctx;
    }
    ...
    public void uncaughtException(Thread t, Throwable e) {
        try {
            ...
            Log.e(ViredroidExceptionHandler.class.getName(),
